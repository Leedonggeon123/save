...
class NoticeMainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        self.notice_button.setStyleSheet("color: #0078ff;")
        ...
        self.notice_title_label = QLabel("공지(모두에게 보내기)")
        self.notice_title_label.setObjectName("noticeTitleLabel")
        body_layout.addWidget(self.notice_title_label)
        
        body_layout.addSpacing(10)
        
        self.notice_text_edit = QTextEdit()
        self.notice_text_edit.setObjectName("noticeTextEdit")
        body_layout.addWidget(self.notice_text_edit)
        ...
        bottom_action_layout.addWidget(self.send_button)
        bottom_action_layout.addStretch()
